...
public class MapView extends View{
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText("SALA", 450, 170, paint);
        ...
        canvas.drawText("GALERIA", 120, 300, paint);
        canvas.drawText("VI", 180, 350, paint);
        ...
        canvas.drawText("GALERIA", 120, 850, paint);
        canvas.drawText("II", 195, 900, paint);
        canvas.drawText("G - II", 160, 660, paint);
        ...
        canvas.drawText("GALERIA III", 410, 660, paint);
        ...
        canvas.drawText("GALERIA I", 460, 1140, paint);
        canvas.drawText("G - I", 170, 1100, paint);
        ...
        canvas.drawText("GALERIA", 855, 700, paint);
        canvas.drawText("V", 915, 750, paint);
        ...
        canvas.drawText("GALERIA", 855, 950, paint);
        canvas.drawText("VI", 915, 1000, paint);
        canvas.drawText("G - VI", 890, 1160, paint);
